...
// ===============================
// TemporalService Protobuf Client
// ===============================
...
// NewTemporalServiceProtobufClient creates a Protobuf client that implements the TemporalService interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewTemporalServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) TemporalService {
		...
		caller = func(ctx context.Context, req *CreateWithdrawRequest) (*pepeunlimited_twirpkit_resources.Withdrawal, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*CreateWithdrawRequest) when calling interceptor")
					}
					return c.callCreateWithdraw(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
...
// NewTemporalServiceJSONClient creates a JSON client that implements the TemporalService interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewTemporalServiceJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) TemporalService {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
// ==============================
// TemporalService Server Handler
// ==============================

type temporalServiceServer struct {
	TemporalService
	interceptor      twirp.Interceptor
...
// NewTemporalServiceServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewTemporalServiceServer(svc TemporalService, opts ...interface{}) TwirpServer {
...
func (s *temporalServiceServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *temporalServiceServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// TemporalServicePathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const TemporalServicePathPrefix = "/twirp/pepeunlimited.twirpkit.services.TemporalService/"

func (s *temporalServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "pepeunlimited.twirpkit.services")
	ctx = ctxsetters.WithServiceName(ctx, "TemporalService")
	...
	if pkgService != "pepeunlimited.twirpkit.services.TemporalService" {
...
func (s *temporalServiceServer) serveCreateWithdraw(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveCreateWithdrawJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveCreateWithdrawProtobuf(ctx, resp, req)
	default:
...
func (s *temporalServiceServer) serveCreateWithdrawJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "CreateWithdraw")
	...
	reqContent := new(CreateWithdrawRequest)
		...
		handler = func(ctx context.Context, req *CreateWithdrawRequest) (*pepeunlimited_twirpkit_resources.Withdrawal, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.TemporalService.CreateWithdraw(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*pepeunlimited_twirpkit_resources.Withdrawal)
...
func (s *temporalServiceServer) serveCreateWithdrawProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "CreateWithdraw")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *temporalServiceServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *temporalServiceServer) ProtocGenTwirpVersion() string {
	return "v8.1.0"
}
...
func (s *temporalServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "pepeunlimited.twirpkit.services", "TemporalService")
}

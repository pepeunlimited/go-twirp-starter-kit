...
docker push "registry.github.com/pepeunlimited/go-twirp-starter-kit:$VERSION_SLUG"
docker push "registry.github.com/pepeunlimited/go-twirp-starter-kit:latest"